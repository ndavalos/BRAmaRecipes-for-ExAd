...
private ["_recipesRecipeList","_goCraftBtn","_backbtn","_recipeList","_recipesPic","_componentsList","_RecipeCategories","_j","_CategoryConfig","_RecipeCategory"];
disableSerialization;

_recipesCategories = _display ctrlCreate ["RscCombo", 85505,_slide];
...
_goCraftBtn = _display ctrlCreate ["RscButtonMenu", 85503,_slide];
...
_backbtn = _display ctrlCreate ["RscButtonMenu", 85504,_slide];
...
_recipeList = _display ctrlCreate ["RscListBox", 85501,_slide];
...
_recipesPic = _display ctrlCreate ["RscPictureKeepAspect", 85507,_slide];
_recipesPic ctrlSetPosition [0.01, 0.43, 0.38, 0.28];
_recipesPic ctrlCommit 0;
_RecipePic ctrlSetText BRAmaRecipesPath + "\BRAma.paa";


_componentsList = _display ctrlCreate ["RscListBox", 85502,_slide];
